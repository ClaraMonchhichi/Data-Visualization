...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard"),style={‘textAlign’: ‘cent’, ‘color’: ‘#503D36’, ‘font-size’: 24}
...
def update_input_container(Recession Period Statistics):
...
def update_output_container(selected, recession_data):
    if selected == 'Recession Period Statistics':
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Average number of vehicles sold by vehicle"))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(figure=px.line(yearly_data,
            x='Year',
            y='Automobile_Sales',
